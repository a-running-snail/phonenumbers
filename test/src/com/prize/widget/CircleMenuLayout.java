...
public class CircleMenuLayout extends ViewGroup {
    ...
    // 每个item 的默认尺寸
    private static final float ITEM_DIMENSION = 3 / 4f;
    //转动快慢
    ...
    // MenuItem的点击事件接口
    private OnItemLongClickListener mOnMenuItemLongClickListener;
    
    private boolean mCanRoll = false;
    
    
    public void setCanRoll(boolean isCan){
        mCanRoll = isCan;
    }
                ...
                itemView.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (mOnMenuItemClickListener != null) {
                            mOnMenuItemClickListener.onItemClick(itemView, position);
                        }
                    }
                });
                itemView.setOnLongClickListener(new OnLongClickListener() {
                    ...
                    public boolean onLongClick(View v) {
                        if (mOnMenuItemLongClickListener != null) {
                            return mOnMenuItemLongClickListener.onItemLongClick(v, position);
                        }
                        return false;
                    }
                });
